...
function assertStrategySnapshotShape(label, snapshot) {
  ...
  assert(typeof snapshot.liveCandidateHistoryJudgment.directionVsTransitionTension === 'boolean', `${label} liveCandidateHistoryJudgment.directionVsTransitionTension missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryJudgment.directionVsTransitionSummaryLine === 'string' && snapshot.liveCandidateHistoryJudgment.directionVsTransitionSummaryLine.length > 0, `${label} liveCandidateHistoryJudgment.directionVsTransitionSummaryLine missing`, { snapshot });
  ...
  assert(typeof snapshot.liveCandidateHistoryJudgment.confidenceReason === 'string' && snapshot.liveCandidateHistoryJudgment.confidenceReason.length > 0, `${label} liveCandidateHistoryJudgment.confidenceReason missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryJudgment.confidenceDrivers), `${label} liveCandidateHistoryJudgment.confidenceDrivers missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryJudgment.confidencePenaltyReasons), `${label} liveCandidateHistoryJudgment.confidencePenaltyReasons missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryJudgmentAudit && typeof snapshot.liveCandidateHistoryJudgmentAudit === 'object', `${label} liveCandidateHistoryJudgmentAudit missing`, { snapshot });
  assert(String(snapshot.liveCandidateHistoryJudgmentAudit.modeUsed || '') === 'loop_only', `${label} liveCandidateHistoryJudgmentAudit.modeUsed should be loop_only`, { snapshot });
  assert(Object.prototype.hasOwnProperty.call(snapshot.liveCandidateHistoryJudgmentAudit, 'sampleSize'), `${label} liveCandidateHistoryJudgmentAudit.sampleSize missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryJudgmentAudit.supportiveRuleHits && typeof snapshot.liveCandidateHistoryJudgmentAudit.supportiveRuleHits === 'object', `${label} liveCandidateHistoryJudgmentAudit.supportiveRuleHits missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryJudgmentAudit.unsupportiveRuleHits && typeof snapshot.liveCandidateHistoryJudgmentAudit.unsupportiveRuleHits === 'object', `${label} liveCandidateHistoryJudgmentAudit.unsupportiveRuleHits missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryJudgmentAudit.neutralRuleHits && typeof snapshot.liveCandidateHistoryJudgmentAudit.neutralRuleHits === 'object', `${label} liveCandidateHistoryJudgmentAudit.neutralRuleHits missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryJudgmentAudit.dominantSupportiveRules), `${label} liveCandidateHistoryJudgmentAudit.dominantSupportiveRules missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryJudgmentAudit.dominantUnsupportiveRules), `${label} liveCandidateHistoryJudgmentAudit.dominantUnsupportiveRules missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryJudgmentAudit.dominantNeutralRules), `${label} liveCandidateHistoryJudgmentAudit.dominantNeutralRules missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryJudgmentAudit.recentClassifiedRows), `${label} liveCandidateHistoryJudgmentAudit.recentClassifiedRows missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryJudgmentAudit.summaryLine === 'string' && snapshot.liveCandidateHistoryJudgmentAudit.summaryLine.length > 0, `${label} liveCandidateHistoryJudgmentAudit.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryStatusCalibration && typeof snapshot.liveCandidateHistoryStatusCalibration === 'object', `${label} liveCandidateHistoryStatusCalibration missing`, { snapshot });
  assert(String(snapshot.liveCandidateHistoryStatusCalibration.modeUsed || '') === 'loop_only', `${label} liveCandidateHistoryStatusCalibration.modeUsed should be loop_only`, { snapshot });
  assert(snapshot.liveCandidateHistoryStatusCalibration.statusRuleMap && typeof snapshot.liveCandidateHistoryStatusCalibration.statusRuleMap === 'object', `${label} liveCandidateHistoryStatusCalibration.statusRuleMap missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryStatusCalibration.statusEvidence && typeof snapshot.liveCandidateHistoryStatusCalibration.statusEvidence === 'object', `${label} liveCandidateHistoryStatusCalibration.statusEvidence missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryStatusCalibration.dominantStatusEffects), `${label} liveCandidateHistoryStatusCalibration.dominantStatusEffects missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibration.statusSourceOfTruth === 'string' && snapshot.liveCandidateHistoryStatusCalibration.statusSourceOfTruth.length > 0, `${label} liveCandidateHistoryStatusCalibration.statusSourceOfTruth missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibration.summaryDerivedFrom === 'string' && snapshot.liveCandidateHistoryStatusCalibration.summaryDerivedFrom.length > 0, `${label} liveCandidateHistoryStatusCalibration.summaryDerivedFrom missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibration.summaryLine === 'string' && snapshot.liveCandidateHistoryStatusCalibration.summaryLine.length > 0, `${label} liveCandidateHistoryStatusCalibration.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryStatusCalibrationDiagnostics && typeof snapshot.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', `${label} liveCandidateHistoryStatusCalibrationDiagnostics missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.consistent === 'boolean', `${label} liveCandidateHistoryStatusCalibrationDiagnostics.consistent missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.inconsistencies), `${label} liveCandidateHistoryStatusCalibrationDiagnostics.inconsistencies missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.statusSourceOfTruth === 'string' && snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.statusSourceOfTruth.length > 0, `${label} liveCandidateHistoryStatusCalibrationDiagnostics.statusSourceOfTruth missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.summaryDerivedFrom === 'string' && snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.summaryDerivedFrom.length > 0, `${label} liveCandidateHistoryStatusCalibrationDiagnostics.summaryDerivedFrom missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.summaryLine === 'string' && snapshot.liveCandidateHistoryStatusCalibrationDiagnostics.summaryLine.length > 0, `${label} liveCandidateHistoryStatusCalibrationDiagnostics.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryActionInterpretation && typeof snapshot.liveCandidateHistoryActionInterpretation === 'object', `${label} liveCandidateHistoryActionInterpretation missing`, { snapshot });
  assert(String(snapshot.liveCandidateHistoryActionInterpretation.modeUsed || '') === 'loop_only', `${label} liveCandidateHistoryActionInterpretation.modeUsed should be loop_only`, { snapshot });
  assert(['supportive', 'mixed', 'weak', 'sparse'].includes(String(snapshot.liveCandidateHistoryActionInterpretation.overallHistoryJudgment || '')), `${label} liveCandidateHistoryActionInterpretation.overallHistoryJudgment invalid`, { snapshot });
  assert(['improving', 'deteriorating', 'neutral', 'insufficient_history'].includes(String(snapshot.liveCandidateHistoryActionInterpretation.recentTransitionBias || '')), `${label} liveCandidateHistoryActionInterpretation.recentTransitionBias invalid`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretation.directionVsTransitionTension === 'boolean', `${label} liveCandidateHistoryActionInterpretation.directionVsTransitionTension missing`, { snapshot });
  assert(['avoid', 'caution', 'stabilization_watch', 'early_reversal_watch', 'supportive_followthrough', 'neutral_wait'].includes(String(snapshot.liveCandidateHistoryActionInterpretation.actionStance || '')), `${label} liveCandidateHistoryActionInterpretation.actionStance invalid`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretation.actionStanceReason === 'string' && snapshot.liveCandidateHistoryActionInterpretation.actionStanceReason.length > 0, `${label} liveCandidateHistoryActionInterpretation.actionStanceReason missing`, { snapshot });
  assert(['defensive', 'neutral', 'constructive'].includes(String(snapshot.liveCandidateHistoryActionInterpretation.actionBias || '')), `${label} liveCandidateHistoryActionInterpretation.actionBias invalid`, { snapshot });
  assert(['reinforces', 'offsets', 'conflicts', 'none'].includes(String(snapshot.liveCandidateHistoryActionInterpretation.confidenceImpact || '')), `${label} liveCandidateHistoryActionInterpretation.confidenceImpact invalid`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretation.requiresFreshConfirmation === 'boolean', `${label} liveCandidateHistoryActionInterpretation.requiresFreshConfirmation missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretation.summaryLine === 'string' && snapshot.liveCandidateHistoryActionInterpretation.summaryLine.length > 0, `${label} liveCandidateHistoryActionInterpretation.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryActionInterpretationAudit && typeof snapshot.liveCandidateHistoryActionInterpretationAudit === 'object', `${label} liveCandidateHistoryActionInterpretationAudit missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretationAudit.ruleUsed === 'string' && snapshot.liveCandidateHistoryActionInterpretationAudit.ruleUsed.length > 0, `${label} liveCandidateHistoryActionInterpretationAudit.ruleUsed missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryActionInterpretationAudit.inputsUsed && typeof snapshot.liveCandidateHistoryActionInterpretationAudit.inputsUsed === 'object', `${label} liveCandidateHistoryActionInterpretationAudit.inputsUsed missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretationAudit.tensionCase === 'string' && snapshot.liveCandidateHistoryActionInterpretationAudit.tensionCase.length > 0, `${label} liveCandidateHistoryActionInterpretationAudit.tensionCase missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryActionInterpretationAudit.stanceAlternativesConsidered), `${label} liveCandidateHistoryActionInterpretationAudit.stanceAlternativesConsidered missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryActionInterpretationAudit.summaryLine === 'string' && snapshot.liveCandidateHistoryActionInterpretationAudit.summaryLine.length > 0, `${label} liveCandidateHistoryActionInterpretationAudit.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryConfirmationGuide && typeof snapshot.liveCandidateHistoryConfirmationGuide === 'object', `${label} liveCandidateHistoryConfirmationGuide missing`, { snapshot });
  assert(String(snapshot.liveCandidateHistoryConfirmationGuide.modeUsed || '') === 'loop_only', `${label} liveCandidateHistoryConfirmationGuide.modeUsed should be loop_only`, { snapshot });
  assert(['avoid', 'caution', 'stabilization_watch', 'early_reversal_watch', 'supportive_followthrough', 'neutral_wait'].includes(String(snapshot.liveCandidateHistoryConfirmationGuide.currentActionStance || '')), `${label} liveCandidateHistoryConfirmationGuide.currentActionStance invalid`, { snapshot });
  assert(['not_needed', 'waiting_for_confirmation', 'partially_confirmed', 'confirmed', 'failed_confirmation'].includes(String(snapshot.liveCandidateHistoryConfirmationGuide.confirmationState || '')), `${label} liveCandidateHistoryConfirmationGuide.confirmationState invalid`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryConfirmationGuide.confirmationTriggers), `${label} liveCandidateHistoryConfirmationGuide.confirmationTriggers missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryConfirmationGuide.confirmationFailures), `${label} liveCandidateHistoryConfirmationGuide.confirmationFailures missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryConfirmationGuide.triggerSummaryLine === 'string' && snapshot.liveCandidateHistoryConfirmationGuide.triggerSummaryLine.length > 0, `${label} liveCandidateHistoryConfirmationGuide.triggerSummaryLine missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryConfirmationGuide.failureSummaryLine === 'string' && snapshot.liveCandidateHistoryConfirmationGuide.failureSummaryLine.length > 0, `${label} liveCandidateHistoryConfirmationGuide.failureSummaryLine missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryConfirmationGuide.nextBestStateIfConfirmed === 'string', `${label} liveCandidateHistoryConfirmationGuide.nextBestStateIfConfirmed missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryConfirmationGuide.summaryLine === 'string' && snapshot.liveCandidateHistoryConfirmationGuide.summaryLine.length > 0, `${label} liveCandidateHistoryConfirmationGuide.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryConfirmationGuideAudit && typeof snapshot.liveCandidateHistoryConfirmationGuideAudit === 'object', `${label} liveCandidateHistoryConfirmationGuideAudit missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryConfirmationGuideAudit.ruleUsed === 'string' && snapshot.liveCandidateHistoryConfirmationGuideAudit.ruleUsed.length > 0, `${label} liveCandidateHistoryConfirmationGuideAudit.ruleUsed missing`, { snapshot });
  assert(snapshot.liveCandidateHistoryConfirmationGuideAudit.inputsUsed && typeof snapshot.liveCandidateHistoryConfirmationGuideAudit.inputsUsed === 'object', `${label} liveCandidateHistoryConfirmationGuideAudit.inputsUsed missing`, { snapshot });
  assert(Object.prototype.hasOwnProperty.call(snapshot.liveCandidateHistoryConfirmationGuideAudit, 'triggerCount'), `${label} liveCandidateHistoryConfirmationGuideAudit.triggerCount missing`, { snapshot });
  assert(Object.prototype.hasOwnProperty.call(snapshot.liveCandidateHistoryConfirmationGuideAudit, 'failureCount'), `${label} liveCandidateHistoryConfirmationGuideAudit.failureCount missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateHistoryConfirmationGuideAudit.unmetCriticalTriggers), `${label} liveCandidateHistoryConfirmationGuideAudit.unmetCriticalTriggers missing`, { snapshot });
  assert(typeof snapshot.liveCandidateHistoryConfirmationGuideAudit.summaryLine === 'string' && snapshot.liveCandidateHistoryConfirmationGuideAudit.summaryLine.length > 0, `${label} liveCandidateHistoryConfirmationGuideAudit.summaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCard && typeof snapshot.liveCandidateTradeTriggerCard === 'object', `${label} liveCandidateTradeTriggerCard missing`, { snapshot });
  assert(String(snapshot.liveCandidateTradeTriggerCard.modeUsed || '') === 'loop_only', `${label} liveCandidateTradeTriggerCard.modeUsed should be loop_only`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.strategyLabel === 'string' && snapshot.liveCandidateTradeTriggerCard.strategyLabel.length > 0, `${label} liveCandidateTradeTriggerCard.strategyLabel missing`, { snapshot });
  assert(Object.prototype.hasOwnProperty.call(snapshot.liveCandidateTradeTriggerCard, 'strategyKey'), `${label} liveCandidateTradeTriggerCard.strategyKey missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.setupLabel === 'string' && snapshot.liveCandidateTradeTriggerCard.setupLabel.length > 0, `${label} liveCandidateTradeTriggerCard.setupLabel missing`, { snapshot });
  assert(['blocked', 'waiting_for_confirmation', 'partially_constructive', 'confirmed_defensive', 'confirmed_supportive'].includes(String(snapshot.liveCandidateTradeTriggerCard.currentState || '')), `${label} liveCandidateTradeTriggerCard.currentState invalid`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.currentStateReason === 'string' && snapshot.liveCandidateTradeTriggerCard.currentStateReason.length > 0, `${label} liveCandidateTradeTriggerCard.currentStateReason missing`, { snapshot });
  assert(['avoid', 'caution', 'stabilization_watch', 'early_reversal_watch', 'supportive_followthrough', 'neutral_wait'].includes(String(snapshot.liveCandidateTradeTriggerCard.currentActionStance || '')), `${label} liveCandidateTradeTriggerCard.currentActionStance invalid`, { snapshot });
  assert(['supportive', 'mixed', 'weak', 'sparse'].includes(String(snapshot.liveCandidateTradeTriggerCard.historyJudgment || '')), `${label} liveCandidateTradeTriggerCard.historyJudgment invalid`, { snapshot });
  assert(['low', 'medium', 'high'].includes(String(snapshot.liveCandidateTradeTriggerCard.historyConfidenceLabel || '')), `${label} liveCandidateTradeTriggerCard.historyConfidenceLabel invalid`, { snapshot });
  assert(['not_needed', 'waiting_for_confirmation', 'partially_confirmed', 'confirmed', 'failed_confirmation'].includes(String(snapshot.liveCandidateTradeTriggerCard.confirmationState || '')), `${label} liveCandidateTradeTriggerCard.confirmationState invalid`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.confirmationNeeded === 'boolean', `${label} liveCandidateTradeTriggerCard.confirmationNeeded missing`, { snapshot });
  assert(Object.prototype.hasOwnProperty.call(snapshot.liveCandidateTradeTriggerCard, 'triggerCount'), `${label} liveCandidateTradeTriggerCard.triggerCount missing`, { snapshot });
  assert(Object.prototype.hasOwnProperty.call(snapshot.liveCandidateTradeTriggerCard, 'failureCount'), `${label} liveCandidateTradeTriggerCard.failureCount missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateTradeTriggerCard.metTriggers), `${label} liveCandidateTradeTriggerCard.metTriggers missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateTradeTriggerCard.missingTriggers), `${label} liveCandidateTradeTriggerCard.missingTriggers missing`, { snapshot });
  assert(Array.isArray(snapshot.liveCandidateTradeTriggerCard.activeFailures), `${label} liveCandidateTradeTriggerCard.activeFailures missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.nextUpgradeState === 'string' && snapshot.liveCandidateTradeTriggerCard.nextUpgradeState.length > 0, `${label} liveCandidateTradeTriggerCard.nextUpgradeState missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.invalidationState === 'string' && snapshot.liveCandidateTradeTriggerCard.invalidationState.length > 0, `${label} liveCandidateTradeTriggerCard.invalidationState missing`, { snapshot });
  assert(['no_trade', 'defensive', 'standard'].includes(String(snapshot.liveCandidateTradeTriggerCard.riskBucket || '')), `${label} liveCandidateTradeTriggerCard.riskBucket invalid`, { snapshot });
  assert(['none', 'quarter_size', 'half_size', 'full_size'].includes(String(snapshot.liveCandidateTradeTriggerCard.sizeGuidance || '')), `${label} liveCandidateTradeTriggerCard.sizeGuidance invalid`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCard.operatorSummaryLine === 'string' && snapshot.liveCandidateTradeTriggerCard.operatorSummaryLine.length > 0, `${label} liveCandidateTradeTriggerCard.operatorSummaryLine missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit && typeof snapshot.liveCandidateTradeTriggerCardAudit === 'object', `${label} liveCandidateTradeTriggerCardAudit missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCardAudit.ruleUsed === 'string' && snapshot.liveCandidateTradeTriggerCardAudit.ruleUsed.length > 0, `${label} liveCandidateTradeTriggerCardAudit.ruleUsed missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit.inputsUsed && typeof snapshot.liveCandidateTradeTriggerCardAudit.inputsUsed === 'object', `${label} liveCandidateTradeTriggerCardAudit.inputsUsed missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit.derivedFromActionInterpretation && typeof snapshot.liveCandidateTradeTriggerCardAudit.derivedFromActionInterpretation === 'object', `${label} liveCandidateTradeTriggerCardAudit.derivedFromActionInterpretation missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit.derivedFromConfirmationGuide && typeof snapshot.liveCandidateTradeTriggerCardAudit.derivedFromConfirmationGuide === 'object', `${label} liveCandidateTradeTriggerCardAudit.derivedFromConfirmationGuide missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit.derivedFromShadowMockTradeDecision && typeof snapshot.liveCandidateTradeTriggerCardAudit.derivedFromShadowMockTradeDecision === 'object', `${label} liveCandidateTradeTriggerCardAudit.derivedFromShadowMockTradeDecision missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit.triggerBreakdown && typeof snapshot.liveCandidateTradeTriggerCardAudit.triggerBreakdown === 'object', `${label} liveCandidateTradeTriggerCardAudit.triggerBreakdown missing`, { snapshot });
  assert(snapshot.liveCandidateTradeTriggerCardAudit.failureBreakdown && typeof snapshot.liveCandidateTradeTriggerCardAudit.failureBreakdown === 'object', `${label} liveCandidateTradeTriggerCardAudit.failureBreakdown missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCardAudit.stateUpgradePath === 'string' && snapshot.liveCandidateTradeTriggerCardAudit.stateUpgradePath.length > 0, `${label} liveCandidateTradeTriggerCardAudit.stateUpgradePath missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCardAudit.stateInvalidationPath === 'string' && snapshot.liveCandidateTradeTriggerCardAudit.stateInvalidationPath.length > 0, `${label} liveCandidateTradeTriggerCardAudit.stateInvalidationPath missing`, { snapshot });
  assert(typeof snapshot.liveCandidateTradeTriggerCardAudit.summaryLine === 'string' && snapshot.liveCandidateTradeTriggerCardAudit.summaryLine.length > 0, `${label} liveCandidateTradeTriggerCardAudit.summaryLine missing`, { snapshot });
  ...
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryJudgmentAudit && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryJudgmentAudit === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryJudgmentAudit missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryJudgmentAudit && typeof snapshot.decisionBoardMirror.liveCandidateHistoryJudgmentAudit === 'object', `${label} decisionBoardMirror.liveCandidateHistoryJudgmentAudit missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryStatusCalibration && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryStatusCalibration === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryStatusCalibration missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryStatusCalibration && typeof snapshot.decisionBoardMirror.liveCandidateHistoryStatusCalibration === 'object', `${label} decisionBoardMirror.liveCandidateHistoryStatusCalibration missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryStatusCalibrationDiagnostics && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryStatusCalibrationDiagnostics missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryStatusCalibrationDiagnostics && typeof snapshot.decisionBoardMirror.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', `${label} decisionBoardMirror.liveCandidateHistoryStatusCalibrationDiagnostics missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryActionInterpretation && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryActionInterpretation === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryActionInterpretation missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryActionInterpretation && typeof snapshot.decisionBoardMirror.liveCandidateHistoryActionInterpretation === 'object', `${label} decisionBoardMirror.liveCandidateHistoryActionInterpretation missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryActionInterpretationAudit && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryActionInterpretationAudit === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryActionInterpretationAudit missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryActionInterpretationAudit && typeof snapshot.decisionBoardMirror.liveCandidateHistoryActionInterpretationAudit === 'object', `${label} decisionBoardMirror.liveCandidateHistoryActionInterpretationAudit missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryConfirmationGuide && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryConfirmationGuide === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryConfirmationGuide missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryConfirmationGuide && typeof snapshot.decisionBoardMirror.liveCandidateHistoryConfirmationGuide === 'object', `${label} decisionBoardMirror.liveCandidateHistoryConfirmationGuide missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateHistoryConfirmationGuideAudit && typeof snapshot.todayRecommendationMirror.liveCandidateHistoryConfirmationGuideAudit === 'object', `${label} todayRecommendationMirror.liveCandidateHistoryConfirmationGuideAudit missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateHistoryConfirmationGuideAudit && typeof snapshot.decisionBoardMirror.liveCandidateHistoryConfirmationGuideAudit === 'object', `${label} decisionBoardMirror.liveCandidateHistoryConfirmationGuideAudit missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateTradeTriggerCard && typeof snapshot.todayRecommendationMirror.liveCandidateTradeTriggerCard === 'object', `${label} todayRecommendationMirror.liveCandidateTradeTriggerCard missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateTradeTriggerCard && typeof snapshot.decisionBoardMirror.liveCandidateTradeTriggerCard === 'object', `${label} decisionBoardMirror.liveCandidateTradeTriggerCard missing`, { snapshot });
  assert(snapshot.todayRecommendationMirror.liveCandidateTradeTriggerCardAudit && typeof snapshot.todayRecommendationMirror.liveCandidateTradeTriggerCardAudit === 'object', `${label} todayRecommendationMirror.liveCandidateTradeTriggerCardAudit missing`, { snapshot });
  assert(snapshot.decisionBoardMirror.liveCandidateTradeTriggerCardAudit && typeof snapshot.decisionBoardMirror.liveCandidateTradeTriggerCardAudit === 'object', `${label} decisionBoardMirror.liveCandidateTradeTriggerCardAudit missing`, { snapshot });
...
(async () => {
  ...
  try {
    ...
    assert(center.liveCandidateHistoryJudgmentAudit && typeof center.liveCandidateHistoryJudgmentAudit === 'object', 'command-center liveCandidateHistoryJudgmentAudit root field missing', { center });
    assert(center.liveCandidateHistoryStatusCalibration && typeof center.liveCandidateHistoryStatusCalibration === 'object', 'command-center liveCandidateHistoryStatusCalibration root field missing', { center });
    assert(center.liveCandidateHistoryStatusCalibrationDiagnostics && typeof center.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', 'command-center liveCandidateHistoryStatusCalibrationDiagnostics root field missing', { center });
    assert(center.liveCandidateHistoryActionInterpretation && typeof center.liveCandidateHistoryActionInterpretation === 'object', 'command-center liveCandidateHistoryActionInterpretation root field missing', { center });
    assert(center.liveCandidateHistoryActionInterpretationAudit && typeof center.liveCandidateHistoryActionInterpretationAudit === 'object', 'command-center liveCandidateHistoryActionInterpretationAudit root field missing', { center });
    assert(center.liveCandidateHistoryConfirmationGuide && typeof center.liveCandidateHistoryConfirmationGuide === 'object', 'command-center liveCandidateHistoryConfirmationGuide root field missing', { center });
    assert(center.liveCandidateHistoryConfirmationGuideAudit && typeof center.liveCandidateHistoryConfirmationGuideAudit === 'object', 'command-center liveCandidateHistoryConfirmationGuideAudit root field missing', { center });
    assert(center.liveCandidateTradeTriggerCard && typeof center.liveCandidateTradeTriggerCard === 'object', 'command-center liveCandidateTradeTriggerCard root field missing', { center });
    assert(center.liveCandidateTradeTriggerCardAudit && typeof center.liveCandidateTradeTriggerCardAudit === 'object', 'command-center liveCandidateTradeTriggerCardAudit root field missing', { center });
    ...
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryJudgmentAudit && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryJudgmentAudit === 'object', 'todayRecommendation liveCandidateHistoryJudgmentAudit mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryJudgmentAudit && typeof center.commandCenter.decisionBoard.liveCandidateHistoryJudgmentAudit === 'object', 'decisionBoard liveCandidateHistoryJudgmentAudit mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryStatusCalibration && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryStatusCalibration === 'object', 'todayRecommendation liveCandidateHistoryStatusCalibration mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryStatusCalibration && typeof center.commandCenter.decisionBoard.liveCandidateHistoryStatusCalibration === 'object', 'decisionBoard liveCandidateHistoryStatusCalibration mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryStatusCalibrationDiagnostics && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', 'todayRecommendation liveCandidateHistoryStatusCalibrationDiagnostics mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryStatusCalibrationDiagnostics && typeof center.commandCenter.decisionBoard.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', 'decisionBoard liveCandidateHistoryStatusCalibrationDiagnostics mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryActionInterpretation && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryActionInterpretation === 'object', 'todayRecommendation liveCandidateHistoryActionInterpretation mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryActionInterpretation && typeof center.commandCenter.decisionBoard.liveCandidateHistoryActionInterpretation === 'object', 'decisionBoard liveCandidateHistoryActionInterpretation mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryActionInterpretationAudit && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryActionInterpretationAudit === 'object', 'todayRecommendation liveCandidateHistoryActionInterpretationAudit mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryActionInterpretationAudit && typeof center.commandCenter.decisionBoard.liveCandidateHistoryActionInterpretationAudit === 'object', 'decisionBoard liveCandidateHistoryActionInterpretationAudit mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryConfirmationGuide && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryConfirmationGuide === 'object', 'todayRecommendation liveCandidateHistoryConfirmationGuide mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryConfirmationGuide && typeof center.commandCenter.decisionBoard.liveCandidateHistoryConfirmationGuide === 'object', 'decisionBoard liveCandidateHistoryConfirmationGuide mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateHistoryConfirmationGuideAudit && typeof center.commandCenter.todayRecommendation.liveCandidateHistoryConfirmationGuideAudit === 'object', 'todayRecommendation liveCandidateHistoryConfirmationGuideAudit mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateHistoryConfirmationGuideAudit && typeof center.commandCenter.decisionBoard.liveCandidateHistoryConfirmationGuideAudit === 'object', 'decisionBoard liveCandidateHistoryConfirmationGuideAudit mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateTradeTriggerCard && typeof center.commandCenter.todayRecommendation.liveCandidateTradeTriggerCard === 'object', 'todayRecommendation liveCandidateTradeTriggerCard mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateTradeTriggerCard && typeof center.commandCenter.decisionBoard.liveCandidateTradeTriggerCard === 'object', 'decisionBoard liveCandidateTradeTriggerCard mirror missing', { center });
    assert(center.commandCenter.todayRecommendation.liveCandidateTradeTriggerCardAudit && typeof center.commandCenter.todayRecommendation.liveCandidateTradeTriggerCardAudit === 'object', 'todayRecommendation liveCandidateTradeTriggerCardAudit mirror missing', { center });
    assert(center.commandCenter.decisionBoard.liveCandidateTradeTriggerCardAudit && typeof center.commandCenter.decisionBoard.liveCandidateTradeTriggerCardAudit === 'object', 'decisionBoard liveCandidateTradeTriggerCardAudit mirror missing', { center });
    assert(
      String(center.liveCandidateTradeTriggerCard.currentState || '') === String(center.commandCenter.todayRecommendation.liveCandidateTradeTriggerCard.currentState || '')
      && String(center.liveCandidateTradeTriggerCard.currentState || '') === String(center.commandCenter.decisionBoard.liveCandidateTradeTriggerCard.currentState || ''),
      'trade-trigger currentState should match across root and mirrors',
      { center }
    );
    assert(
      String(center.liveCandidateTradeTriggerCard.operatorSummaryLine || '') === String(center.commandCenter.todayRecommendation.liveCandidateTradeTriggerCard.operatorSummaryLine || '')
      && String(center.liveCandidateTradeTriggerCard.operatorSummaryLine || '') === String(center.commandCenter.decisionBoard.liveCandidateTradeTriggerCard.operatorSummaryLine || ''),
      'trade-trigger operatorSummaryLine should match across root and mirrors',
      { center }
    );
    ...
    assert(perf.recommendationPerformance.liveCandidateHistoryJudgmentAudit && typeof perf.recommendationPerformance.liveCandidateHistoryJudgmentAudit === 'object', 'recommendationPerformance.liveCandidateHistoryJudgmentAudit missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateHistoryStatusCalibration && typeof perf.recommendationPerformance.liveCandidateHistoryStatusCalibration === 'object', 'recommendationPerformance.liveCandidateHistoryStatusCalibration missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateHistoryStatusCalibrationDiagnostics && typeof perf.recommendationPerformance.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', 'recommendationPerformance.liveCandidateHistoryStatusCalibrationDiagnostics missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateHistoryActionInterpretation && typeof perf.recommendationPerformance.liveCandidateHistoryActionInterpretation === 'object', 'recommendationPerformance.liveCandidateHistoryActionInterpretation missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateHistoryActionInterpretationAudit && typeof perf.recommendationPerformance.liveCandidateHistoryActionInterpretationAudit === 'object', 'recommendationPerformance.liveCandidateHistoryActionInterpretationAudit missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateHistoryConfirmationGuide && typeof perf.recommendationPerformance.liveCandidateHistoryConfirmationGuide === 'object', 'recommendationPerformance.liveCandidateHistoryConfirmationGuide missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateHistoryConfirmationGuideAudit && typeof perf.recommendationPerformance.liveCandidateHistoryConfirmationGuideAudit === 'object', 'recommendationPerformance.liveCandidateHistoryConfirmationGuideAudit missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateTradeTriggerCard && typeof perf.recommendationPerformance.liveCandidateTradeTriggerCard === 'object', 'recommendationPerformance.liveCandidateTradeTriggerCard missing', { perf });
    assert(perf.recommendationPerformance.liveCandidateTradeTriggerCardAudit && typeof perf.recommendationPerformance.liveCandidateTradeTriggerCardAudit === 'object', 'recommendationPerformance.liveCandidateTradeTriggerCardAudit missing', { perf });
    ...
    assert(perf.liveCandidateHistoryJudgment && typeof perf.liveCandidateHistoryJudgment === 'object', 'recommendation/performance root liveCandidateHistoryJudgment missing', { perf });
    assert(perf.liveCandidateHistoryJudgmentAudit && typeof perf.liveCandidateHistoryJudgmentAudit === 'object', 'recommendation/performance root liveCandidateHistoryJudgmentAudit missing', { perf });
    assert(perf.liveCandidateHistoryStatusCalibration && typeof perf.liveCandidateHistoryStatusCalibration === 'object', 'recommendation/performance root liveCandidateHistoryStatusCalibration missing', { perf });
    assert(perf.liveCandidateHistoryStatusCalibrationDiagnostics && typeof perf.liveCandidateHistoryStatusCalibrationDiagnostics === 'object', 'recommendation/performance root liveCandidateHistoryStatusCalibrationDiagnostics missing', { perf });
    assert(perf.liveCandidateHistoryActionInterpretation && typeof perf.liveCandidateHistoryActionInterpretation === 'object', 'recommendation/performance root liveCandidateHistoryActionInterpretation missing', { perf });
    assert(perf.liveCandidateHistoryActionInterpretationAudit && typeof perf.liveCandidateHistoryActionInterpretationAudit === 'object', 'recommendation/performance root liveCandidateHistoryActionInterpretationAudit missing', { perf });
    assert(perf.liveCandidateHistoryConfirmationGuide && typeof perf.liveCandidateHistoryConfirmationGuide === 'object', 'recommendation/performance root liveCandidateHistoryConfirmationGuide missing', { perf });
    assert(perf.liveCandidateHistoryConfirmationGuideAudit && typeof perf.liveCandidateHistoryConfirmationGuideAudit === 'object', 'recommendation/performance root liveCandidateHistoryConfirmationGuideAudit missing', { perf });
    assert(perf.liveCandidateTradeTriggerCard && typeof perf.liveCandidateTradeTriggerCard === 'object', 'recommendation/performance root liveCandidateTradeTriggerCard missing', { perf });
    assert(perf.liveCandidateTradeTriggerCardAudit && typeof perf.liveCandidateTradeTriggerCardAudit === 'object', 'recommendation/performance root liveCandidateTradeTriggerCardAudit missing', { perf });
